...
use crate::geom::{Rect, Vector, Point, Size};
...
impl Font {
    ...
    pub fn render(&self, gfx: &Graphics, text: &str, size: usize, ratio: f32) -> Result<(Image, Vec<Rect>)> {
        ...
        let img = Image::from_raw(gfx,
                        ...
                        max_width as u32,
                        height as u32,
                        PixelFormat::RGBA).expect("failed to create image");
        Ok((img, rect_vec))
    }
}
